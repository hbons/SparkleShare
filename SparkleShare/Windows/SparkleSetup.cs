                ...
                Dispatcher.BeginInvoke((Action) delegate {
                    ...
                    switch (type) {
                        ...
                        case PageType.Add: {
                                ...
                                header_style.Setters.Add(new Setter(GridViewColumnHeader.VisibilityProperty,
                        ...
                        case PageType.CryptoSetup: {
                                ...
                                TextBlock info_label = new TextBlock() {
                                    Text =
                                        "This password can’t be changed later, and your files can’t be recovered if it’s forgotten.",
                                    TextWrapping = TextWrapping.Wrap,
                                    Width = 315
                                };
                                ...
                                Image warning_image = new Image() {
                                    Source =
                                        Imaging.CreateBitmapSourceFromHIcon(Drawing.SystemIcons.Information.Handle,
                        ...
                        case PageType.Tutorial: {
                                switch (Controller.TutorialPageNumber) {
                                    ...
                                    case 4: {
                                            ...
                                            Description =
                                                "You’ll need it whenever you want to link this computer to a host. " +
